...
<body>
  ...
  <?php
    ...
    if(isset($_POST['signup'])){
      ...
      $aluno = $alunoController->recuperarAluno($username);
      ...
      if( $aluno?->getNome()  ){
        ...
        echo "<p style='color:white;background-color:red'> Usuário ou senha incorreto  </p>";
      }
  ...
  <div class="login-box">
    ...
    <form method="post" name="login" action="">
      ...
      <input type="submit" value="Entrar"  name="signup"> 
...
<!-- 
  ...
  Fonte de referencia :
    ...
    Fonte de referencia PHP:
    -> https://code.tutsplus.com/tutorials/create-a-php-login-form--cms-33261
    -> https://www.youtube.com/watch?v=eEhsvuLWBg8
